...
jeans.prototype = {
  step: function() {
    ...
    parents = parents.concat(roulette(this, this.populationSize / 2 - this.eliteSize, this.population.slice(this.eliteSize)));

    var children = [];
    for (var i = 0; i < this.populationSize; i++) {
      children.push(this.mutate(this.reproduce(
  ...
  mutate: function(individual) {
    Object.keys(this.mutators).forEach(function(mutator) {
      individual[mutator] = this.mutators[mutator].call(this, individual[mutator]);
    }, this);
    return individual;
  }
};
